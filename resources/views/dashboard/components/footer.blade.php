...
<footer class="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
    ...
    <div class="flex space-x-6 sm:justify-center">
        ...
        <a href="https://github.com/c-darren" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
{{-- <p class="my-10 text-sm text-center text-gray-500">
    &copy; 2024-2023 <a href="https://flowbite.com/" class="hover:underline" target="_blank">Flowbite.com</a>. All rights reserved.
</p> --}}
@endsection