...
<section class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-screen-xl bg-white rounded-lg shadow dark:border dark:bg-gray-800 dark:border-gray-700 px-6 py-8">
        <div class="flex flex-col items-center">
            <h2 class="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Add A New User</h2>
            <div id="addusersFormView" class="w-full">
