    ...
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
        <li class="me-2">
            ...
            {{ request()->segment(4) === 'view' ? 'aria-current="page"' : '' }}>
                ...
                {{ request()->segment(4) === 'view' ? ' text-blue-600 dark:text-blue-500' : ' text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'}}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <li class="me-2">
            ...
            {{ request()->segment(4) === 'view' ? 'aria-current="page"' : '' }}>
                <svg class="w-4 h-4 me-2
                {{ request()->segment(4) === 'view' ? ' text-blue-600 dark:text-blue-500' : ' text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'}}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
