...
<section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div class="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
            ...
            <form method="POST" class="mt-4 space-y-4 lg:mt-5 md:space-y-5" id="input-password-reset-form" action="{{ route('password.update') }}">
                @csrf
                @method("PATCH")
                ...
                <div class="relative">
                    ...
                    <button type="button" id="togglePassword" 
                            class="absolute top-10 right-3 text-sm text-gray-600 dark:text-gray-300">
                        <svg id="eyePath" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
