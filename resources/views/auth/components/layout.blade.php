...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ Storage::url('website/favicon.png') }}">
...
<body class="bg-white dark:bg-gray-900 h-full">
    <div id="app" class="h-full relative">
        <button id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 absolute top-0 right-0 z-10">
