    ...
    @forelse($resources as $resource)
        @php
            if ($resource->type === 'material') {
                ...
                $route_show = route('student.classroom.resources.show', [$masterClass_id, $classList->id, 'material', $resource->id]);
            } elseif ($resource->type === 'assignment') {
                $name = $resource->assignment_name;
                $author = $resource->author->name;
                $description = strtolower($resource->description);
                $route_show = route('student.classroom.resources.show', [$masterClass_id, $classList->id, 'assignment' ,$resource->id]);
            }
        @endphp
