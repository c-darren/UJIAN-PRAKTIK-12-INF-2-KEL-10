...
function showDeleteModal(button) {
    ...
    const displayRoutePrefixUrl = document.getElementById('display_delete_role_name');
    displayRoutePrefixUrl.textContent = deleteRoleName;
    ...
    modal.setAttribute('data-delete_prefix_url', deleteRoleName);
...
function confirmDelete(button) {
    ...
    const deleteRoleName = modal.getAttribute('data-delete_prefix_url');
    ...
    if (!confirm_route_prefix_url) {
        ...
        return;
    } else if (confirm_route_prefix_url != deleteRoleName) {
        Notiflix.Notify.failure(
